...
<<<<<<< HEAD:public/js/three/threeController.js
=======
angular.module('snippit', ['snippit.main',
  'snippit.services',
  'snippit.three',
...
>>>>>>> changes to profile css:public/dist/js/main.js
angular.module('snippit.three', ['snippit'])
  .controller('ThreeController', ['$scope', 'ThreeFactory', '$window', '$document', 'Facebook', function($scope, ThreeFactory, $window, $document, Facebook) {
    ...
    var init = function(){
      ...
      for (var i = 0; i < len; i++) {
        ThreeFactory.createObject(i, picData, scene, $scope.objects, $scope.hit);
